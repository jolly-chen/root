...
/**
 ...
 Note that this file is basically a copy of CUDAFillHelper, except "CUDA" is replaced with "SYCL".
*/
...
public:
   ...
   inline void init_SYCL(HIST *obj, int i)
   {
      ...
      fSYCLHist[i] =
         new RHnSYCL<decltype(getHistType((HIST *)nullptr)), dim>(ncells, xlow, xhigh, binEdges.data());
   }
